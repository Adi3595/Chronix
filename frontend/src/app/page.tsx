...
export default function LandingPage() {
  ...
  return (
    <div ref={containerRef} className="text-foreground antialiased min-h-screen selection:bg-primary selection:text-background relative bg-background bg-cover bg-center bg-fixed bg-no-repeat" style={{ backgroundImage: "var(--sys-bg-image)" }}>
      ...
      <section className="pt-[60px] pb-[120px] relative z-10 bg-transparent overflow-hidden" id="about">
              ...
              >
                <Link href="/signup">
                  <motion.div
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="bg-primary text-background px-8 py-4 rounded-full font-sans text-[14px] font-bold uppercase tracking-widest transition-all cursor-pointer shadow-[0_0_30px_rgba(29,46,27,0.4)] dark:shadow-[0_0_30px_rgba(46,125,50,0.4)]"
                  >
                    Start Planning &rarr;
                  </motion.div>
                </Link>
