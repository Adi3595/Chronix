  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      if (auth) {
        ...
        document.cookie = `chronix-uid=${userCredential.user.uid}; path=/; max-age=31536000;`;
        router.push(getRedirectUrl());
      } else {
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="bg-surface p-10 border border-outline-variant w-full max-w-md relative z-10 shadow-[0_0_40px_rgba(0,0,0,0.5)]">
        ...
        <div className="text-center mb-10">
          <h1 className="font-sans font-black text-[32px] text-foreground uppercase tracking-tighter mb-2">Welcome Back</h1>
          <p className="font-mono text-[12px] text-muted-foreground uppercase tracking-widest">Enter your credentials to continue</p>
        </div>
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-4">
            ...
            <div className="text-center mt-6">
              <p className="text-[12px] text-muted-foreground font-mono">
                ...
                <Link href="/signup" className="text-primary font-bold hover:underline uppercase tracking-widest">
                  Sign up
                </Link>
              </p>
            </div>
