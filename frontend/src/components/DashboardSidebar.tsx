    ...
    <>
      ...
      <div className="mb-8 px-4 flex justify-between items-center">
        <div className="flex items-center gap-3">
          <img
            alt="Chronix OS Logo"
            className="w-10 h-10 object-contain mix-blend-screen [filter:invert(1)_hue-rotate(180deg)]"
            src="/icon.png"
          />
          <div>
  ...
  return (
    <>
      ...
      <div className="md:hidden flex justify-between items-center mb-6 pb-4 border-b border-outline-variant/50 sticky top-0 bg-background z-40 px-6 pt-6">
        <div className="flex items-center gap-3">
          <img src="/icon.png" className="w-8 h-8 object-contain mix-blend-screen [filter:invert(1)_hue-rotate(180deg)]" alt="Logo" />
